...
class User {
	...
	public function getNewsTitlesPagination($start_from, $num_per_page){
        $query = "SELECT news.id, news.title, news.body, news.image, news.category, news.content_writer, news.date  FROM news LIMIT $start_from,$num_per_page";
        $stmt = $this->pdo->prepare($query);
	...
	public function getCountFromNews() {
		$cnt = getCount("SELECT count(*) FROM news");
		return $cnt;
	}
	
	public function getLivingStyleNewsCount(){
        $query = "SELECT COUNT(*) c FROM news WHERE  news.category = 'LivingStyle'";
        $stmt = $this->pdo->prepare($query);
    ...
    public function getLivingStyleNewsPagination($start_from, $num_per_page){
        $query = "SELECT news.id, news.title, news.body, news.image, news.category, news.content_writer, news.date  FROM news WHERE  news.category = 'LivingStyle' LIMIT $start_from,$num_per_page";
        $stmt = $this->pdo->prepare($query);
    ...
    public function getLivingStyleNews(){
        $query = "SELECT news.id, news.title, news.body, news.image, news.category, news.content_writer, news.date  FROM news WHERE news.category = 'LivingStyle'";
        $stmt = $this->pdo->prepare($query);
    ...
    public function getSinglePost($post){
	 ...
	 public function getAllMmNews($start_from, $num_per_page){
        $query = "SELECT *  FROM news WHERE  news.isEng = '0' order by date asc LIMIT $start_from,$num_per_page";
        $stmt = $this->pdo->prepare($query);
	...
	public function getRecentMmNews(){
        $query = "SELECT * from news WHERE news.isEng = '0' order by date asc limit 3";
        $stmt = $this->pdo->prepare($query);
	...
	public function getAllEnNews($start_from, $num_per_page){
        $query = "SELECT *  FROM news WHERE  news.isEng = '1' order by date asc LIMIT $start_from,$num_per_page";
        $stmt = $this->pdo->prepare($query);
	...
	public function getRecentNews(){
        $query = "SELECT * from news order by date asc limit 3";
        $stmt = $this->pdo->prepare($query);
