			...
			<div class="row align-items-center">
				<div class="col-xl-12 col-lg-12 col-md-12 col-12">
					...
					<div
						...
						<div>
							<a href="add-course.html" class="btn btn-primary btn-sm d-none d-md-block">Create New Category</a>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Content -->
            ...
            <div class="card">
              <div style="display: inline-block;">
                <span style="float: left;"><h4 class="pt-3 mb-0">Aritificial Intelligence</h4></span>
                <span class="mt-3" style="float: right;"><i class="fe fe-edit fs-6" style="margin-right: 10px;"></i><i class="fe fe-trash-2 fs-6"></i></span>
              </div>
              <p class="mb-4 mt-1">
